...
?>
 ...
 <div class="quotation"><center>Add New Client</center></div>
        ...
        <tr><td class="l_form">Company Name:</td><td><input id="compname" class="q_in" type="text" name="c_lname"/></td></tr>
                <tr><td class="l_form">Contact Person Name:</td><td><input id="cname" class="q_in" type="text" name="c_fname" /></td></tr>
